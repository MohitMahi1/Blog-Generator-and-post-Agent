...
import type { GenerateResponse, Plan, EvidenceItem, ImageSpec } from './types/blog';
...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Note: current backend only returns limited fields.
      // When you improve the backend response we can populate plan/evidence/images here.
